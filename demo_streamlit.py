...
if choice == 'Display Text':
    ...
    st.text("Khoá học được thiết kế nhằm ôn tập và bổ sung kiến thức cho HV.")
    ...
    st.write('Display boxplot- Pclass vs Fare')
    fig, ax = plt.subplots()
